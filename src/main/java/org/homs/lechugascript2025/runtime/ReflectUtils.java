...
public class ReflectUtils {
    ...
    public static Object callMethod(Object target, String methodName, List<Object> args) throws RuntimeException {
        try {
            ...
            for (Method method : targetClass.getMethods()) {
                if (method.getName().equals(methodName) && method.getParameterCount() == args.size()) {
                    ...
                    for (int i = 0; i < method.getParameterCount(); i++) {
                        if (args.get(i) != null
                                && !isAssignableFrom(method.getParameters()[i].getType(), args.get(i).getClass())) {
                            typesMatches = false;
                            break;
                        }
                    }
            ...
            throw new RuntimeException("no method found for: " + targetClass.getName() + "#" + methodName + args);
